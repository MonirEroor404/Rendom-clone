'''
Decoded By - Monir
All Bug Fixed By - Monir
FB Id:https://www.facebook.com/mdmonirhossen62
'''
...
{A}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
{G1}[{A}≈{G1}]{G1} DEVELOPER {A}➢{G1}MONIR\_____ :* \❷/ 3:) \⓿
...
def menu():
    ...
    if sex in ['1']:
        ...
        os.system('xdg-open https://t.me/DARK_LMNx999');menu()
    elif sex in ['0']:
        sys.exit()
    else:
        menu()
...
if __name__ == '__main__':
    os.system('xdg-open https://www.facebook.com/mdmonirhossen62');menu()